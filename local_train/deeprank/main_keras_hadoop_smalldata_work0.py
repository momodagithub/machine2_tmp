...
os.environ['TF_CONFIG'] = json.dumps({
    'cluster': {
        'worker': ["hwyc-reco-train-01:12345", "hwyc-reco-train-01:12340"]
    },
...
def train(tfrecord_files, epochs=1, batch_size=1024, lr=1e-4):
    ...
    ds = build_dataset(tfrecord_files, batch_size=batch_size*NUM_WORKERS)
